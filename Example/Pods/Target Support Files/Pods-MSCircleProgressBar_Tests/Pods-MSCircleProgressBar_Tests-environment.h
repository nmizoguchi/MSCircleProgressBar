...
// MSCircleProgressBar
#define COCOAPODS_POD_AVAILABLE_MSCircleProgressBar
#define COCOAPODS_VERSION_MAJOR_MSCircleProgressBar 0
#define COCOAPODS_VERSION_MINOR_MSCircleProgressBar 1
#define COCOAPODS_VERSION_PATCH_MSCircleProgressBar 0
